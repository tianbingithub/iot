...
3.  在左侧导航栏，选择**设备管理** \> **产品**，找到您的产品，单击产品名称右侧的**查看**。

4.  在产品详情页面，选择功能定义页签，添加如下图自定义功能。

    ![添加自定义服务](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/1631649951/p58010.png)

    自定义功能相关参数说明请参见[单个添加物模型](/cn.zh-CN/设备管理/物模型/单个添加物模型.md)。

5.  添加如下图**输入参数**和**输出参数**。

    ![输入参数](../images/p58015.png "输入参数")

    ![输出参数](../images/p58017.png "输出参数")
...
2.  增加Java类，修改Config.\*文件中的参数为您的设备信息。

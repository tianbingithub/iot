...
物联网平台支持基于HTTPS通道实现[一型一密](/cn.zh-CN/设备接入/设备安全认证/一型一密.md)预注册认证，设备通过动态注册获取连接云端所需的DeviceSecret。相关Topic和参数说明，请参见[直连设备使用一型一密动态注册](/cn.zh-CN/设备管理/Alink协议/设备身份注册.md)。

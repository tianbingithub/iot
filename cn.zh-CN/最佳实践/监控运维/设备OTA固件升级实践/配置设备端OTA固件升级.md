...
本示例中，设备端开发使用阿里云提供的C语言Link SDK 3.x。请访问[Link SDK](https://help.aliyun.com/document_detail/96623.html)下载SDK Demo。
...
2.  编译更新后的linkkit\_example\_solo.c文件，并保存编译后的.bin文件。
    ...
    在下一步[推送固件到设备端](/cn.zh-CN/最佳实践/监控运维/设备OTA固件升级实践/推送固件到设备端.md)，您需在物联网平台控制台添加升级包，上传该.bin文件。
